    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 container mx-auto p-4 md:p-6">
        <section className="text-center w-full py-20 md:py-32 flex flex-col justify-center items-center">
          <h1 className="text-7xl sm:text-8xl md:text-9xl lg:text-[10rem] font-bold font-headline leading-none mb-4 bg-gradient-to-r from-purple-400 to-pink-500 text-transparent bg-clip-text animate-background-pan bg-[200%_auto]">
            Nivora
          </h1>
